...
var host = data["ip"];
var username = generateRandomUsername(); // <--- This is the key change
...
function createBot() {
    ...
    const bot = mineflayer.createBot({
        ...
        username: username,
        version: '1.21.7',
        port: parseInt(data.port) // Ensure the port is an integer
    });
    ...
    // Reconnection handler to automatically rejoin after being kicked.
